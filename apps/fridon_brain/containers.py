...
from apps.fidrox_brain import services
...
class Container(containers.DeclarativeContainer):
    wiring_config = containers.WiringConfiguration(
        modules=[
            ...
            "apps.fidrox_brain.services.process_user_message_service",
            "apps.fidrox_brain.services.calculate_user_message_score_service",
        ],
        packages=[
